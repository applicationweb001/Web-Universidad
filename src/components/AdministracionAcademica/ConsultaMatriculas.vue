      ...
      >
        <template v-slot:top>
          <v-toolbar flat color="white">
            <v-toolbar-title>Matriculas por Semestre</v-toolbar-title>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Carrera", value: "carrera", sortable: true },
      { text: "Cursos Matriculados", value: "cursosalumno", sortable: true },
      { text: "Ciclo Academico", value: "anioacademico", sortable: true },
